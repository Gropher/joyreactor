 ...
 */
class BasePostCommentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'parent_id'  => new sfWidgetFormDoctrineChoice(array('model' => 'PostComment', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'parent_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => 'PostComment', 'column' => 'id')),
