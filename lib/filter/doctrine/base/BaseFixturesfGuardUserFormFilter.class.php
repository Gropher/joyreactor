...
/**
 * FixturesfGuardUser filter form base class.
 *
 * @package    filters
 * @subpackage FixturesfGuardUser *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseFixturesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fixturesf_guard_user_filters[%s]');
