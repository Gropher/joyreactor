 ...
 */
   ...
   *   <? echo link_to_function(image_tag('delete'), "do_delete()", array('confirm' => 'Really?')) ?>
   */
   ...
   *
   * Examples:
   *   <? echo button_to_function('Greeting', "alert('Hello world!')") ?>
   */
   ...
   * Example:
   *   <? echo javascript_tag("alert('All is good')") ?>
   *   => <script type="text/javascript">alert('All is good')</script>
   *   <? javascript_tag() ?>alert('All is good')<? end_javascript_tag() ?>
   */
