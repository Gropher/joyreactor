...
<head>
  ...
  <title><? echo $name ?>: <? echo htmlspecialchars($message, ENT_QUOTES, sfConfig::get('sf_charset', 'UTF-8')) ?></title>
  <style type="text/css">
...
<body>
  ...
  <h1><? echo $code ?> | <? echo $text ?> | <? echo $name ?></h1>
  <h2 id="message"><? echo str_replace("\n", '<br />', htmlspecialchars($message, ENT_QUOTES, sfConfig::get('sf_charset', 'UTF-8'))) ?></h2>
  <h2>stack trace</h2>
  <ul><li><? echo implode('</li><li>', $traces) ?></li></ul>

  <h2>symfony settings <a href="#" onclick="toggle('sf_settings'); return false;">...</a></h2>
  <div id="sf_settings" style="display: none"><? echo $settingsTable ?></div>

  <h2>request <a href="#" onclick="toggle('sf_request'); return false;">...</a></h2>
  <div id="sf_request" style="display: none"><? echo $requestTable ?></div>

  <h2>response <a href="#" onclick="toggle('sf_response'); return false;">...</a></h2>
  <div id="sf_response" style="display: none"><? echo $responseTable ?></div>

  <h2>user <a href="#" onclick="toggle('sf_user'); return false;">...</a></h2>
  <div id="sf_user" style="display: none"><? echo $userTable ?></div>

  <h2>global vars <a href="#" onclick="toggle('sf_globals'); return false;">...</a></h2>
  <div id="sf_globals" style="display: none"><? echo $globalsTable ?></div>

  <p id="footer">
    symfony v.<? echo SYMFONY_VERSION ?> - php <? echo PHP_VERSION ?><br />
