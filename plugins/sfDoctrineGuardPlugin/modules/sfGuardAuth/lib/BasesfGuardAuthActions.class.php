...
class BasesfGuardAuthActions extends sfActions
{
  public function executeSignin($request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        return $this->redirect('' != $signinUrl ? $signinUrl : sfConfig::get('app_sf_guard_plugin_success_signin_url'));
      }
    }
    else
    {
  ...
  public function executeSignout($request)
  {
    ...
    $signout_url = $request->getReferer();

    $this->redirect('' != $signout_url ? $signout_url : sfConfig::get('app_sf_guard_plugin_success_signout_url'));
  }
